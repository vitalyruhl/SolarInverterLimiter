...
String Config::toJSON()
{
    ...
    doc["wifi"]["fo_ssid"] = wifi_config.failover_ssid;
    doc["wifi"]["fo_pass"] = wifi_config.failover_pass;
    doc["wifi"]["AP_ssid"] = wifi_config.apSSID;
    doc["wifi"]["IP"] = wifi_config.staticIP;
    doc["wifi"]["SN"] = wifi_config.staticSubnet;
    doc["wifi"]["GW"] = wifi_config.staticGateway;
    doc["wifi"]["DNS"] = wifi_config.staticDNS;
    doc["wifi"]["use_sp"] = wifi_config.use_static_ip;
...
void Config::fromJSON(const String &json)
{
    ...
    wifi_config.failover_ssid = doc["wifi"]["fo_ssid"].as<String>();
    wifi_config.failover_pass = doc["wifi"]["fo_pass"].as<String>();
    wifi_config.apSSID = doc["wifi"]["AP_ssid"].as<String>();
    wifi_config.staticIP = doc["wifi"]["IP"].as<String>();
    wifi_config.staticSubnet = doc["wifi"]["SN"].as<String>();
    wifi_config.staticGateway = doc["wifi"]["GW"].as<String>();
    wifi_config.staticDNS = doc["wifi"]["DNS"].as<String>();
    wifi_config.use_static_ip = doc["wifi"]["use_sp"].as<bool>();
